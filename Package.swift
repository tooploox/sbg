...
//        .package(url: "https://github.com/tuist/xcodeproj.git", .upToNextMajor(from: "6.0.0")),
        .package(url: "https://github.com/Vyeczorny/xcodeproj.git", .branch("master")), // change when PR: https://github.com/tuist/xcodeproj/pull/343 will be merged
    ...
    targets: [
        ...
        .target(
            name: "SBGCore",
            dependencies: ["Stencil", "xcodeproj", "PathKit"]),
        .testTarget(
            name: "SBGTests",
